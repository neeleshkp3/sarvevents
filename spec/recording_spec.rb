...
RSpec.describe SARVEvents::Recording do
  context "#metadata" do
  ...
  context "#attendees" do
    ...
    it "should properly parse list of attendees." do
      expect(@sample.attendees).to all(be_an_instance_of(SARVEvents::Attendee))
    end
  end
  ...
  context "#polls" do
    ...
    it "should properly parse list of polls." do
      expect(@sample.polls).to all(be_an_instance_of(SARVEvents::Poll))
    end
  end
